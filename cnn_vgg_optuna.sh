#!/bin/bash
#SBATCH --job-name=train-vgg-gpu-optuna
...
#SBATCH --output=../slurm_files/vgg/slurm-%x-%j.out     # where to write output, %x give job name, %j names job id
#SBATCH --error=../slurm_files/vgg/slurm-%x-%j.err      # where to write slurm error
