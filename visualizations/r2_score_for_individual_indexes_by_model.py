...
combined_data = pd.read_csv('model_results_wealth.csv')
...
plt.ylim(0.67, 0.74)  # Set a lower limit for the y-axis to start at 0

plt.title("R² Scores for Different Individual Indexes by Model (wealth)")
plt.xlabel("Model")
plt.ylabel("R² Score")
